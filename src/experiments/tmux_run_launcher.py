...
#         [0, 0.4]
# ):
#     current_run_name = f"HFpre_MLM_SOP_lambda_{current_lambda}_run2_CORRECT"
#     current_description = f"A CORRECT second run at lambda {current_lambda} with the upgraded baseline. (With correct DIR and objective flags)"
#     RUNS[current_run_name] = {'commands': [
#         f"ssh {current_server}",
#
#         f"conda activate p1;python pretrain.py --run_name={current_run_name} --description=\"{current_description}\" "
...
#     current_description = f"A third run at lambda {current_lambda} with the upgraded baseline."
#     RUNS[current_run_name] = {'commands': [
#         f"ssh {current_server}",
#
#         f"conda activate p1;python pretrain.py --run_name={current_run_name} --description=\"{current_description}\" "
...
# current_description = f"Run to create 'Intermediate-v2-level' model for slowness probing"
# RUNS[current_run_name] = {'commands': [
#     f"ssh {current_server}",
# 
#     f"conda activate p1;python pretrain.py --run_name={current_run_name} --description=\"{current_description}\" "
