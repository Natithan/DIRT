...
#                       "If not, it is probs due to the pretraining data/objective"
...
current_server = 'bilbo'
current_run_name = "combo_noHFpre_mypre_3"
current_description = "Re-running my combo DIRT alt, this time with saving 5 checkpoints, and training for max 5 epochs"
RUNS[current_run_name] = [
        f"ssh {current_server}",
...
current_server = 'bilbo'
current_run_name = "vanilla_noHFpre_mypre_2"
current_description = "Re-running my from scratch vanilla to form baseline for combo DIRT alt. " \
                      "This time with saving 5 checkpoints, and training for max 5 epochs."
RUNS[current_run_name] = [
    f"ssh {current_server}",
